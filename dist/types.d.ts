 ...
 */
export type StandardPartsOfSpeech = "adjective" | "adverb" | "ambiposition" | "article" | "circumposition" | "classifier" | "conjunction" | "contraction" | "counter" | "determiner" | "ideophone" | "interjection" | "noun" | "numeral" | "participle" | "particle" | "postposition" | "preposition" | "pronoun" | "proper-noun" | "verb" | "circumfix" | "combining-form" | "infix" | "interfix" | "prefix" | "root" | "suffix" | "diacritical-mark" | "letter" | "ligature" | "number" | "punctuation-mark" | "syllable" | "symbol" | "phrase" | "proverb" | "prepositional-phrase" | "han-character" | "hanzi" | "kanji" | "hanja" | "romanization" | "logogram" | "determinative";
export type DisallowedPartOfSpeech = "abbreviation" | "acronym" | "initialism" | "cardinal-number" | "ordinal-number" | "cardinal-numeral" | "ordinal-numeral" | "clitic" | "gerund" | "idiom";
